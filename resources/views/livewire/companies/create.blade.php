        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="country_id" type="text" class="form-control" id="country_id" placeholder="Country Id">@error('country_id') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
